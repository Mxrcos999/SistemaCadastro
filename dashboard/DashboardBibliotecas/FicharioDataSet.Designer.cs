...
namespace DashboardBibliotecas {
    ...
    public partial class FicharioDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TableRow AddTableRow(string username, string password, byte[] photo) {
...
namespace DashboardBibliotecas.FicharioDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([username], [password], [photo]) VALUES (@username, @p" +
                "assword, @photo);\r\nSELECT username, password, photo FROM [Table] WHERE (username" +
                " = @username)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Table] SET [username] = @username, [password] = @password, [photo] " +
                "= @photo WHERE (([username] = @Original_username) AND ([password] = @Original_pa" +
                "ssword));\r\nSELECT username, password, photo FROM [Table] WHERE (username = @user" +
                "name)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DashboardBibliotecas.Properties.Settings.Default.FicharioConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT username, password, photo FROM dbo.[Table]";
        ...
        public virtual int Fill(FicharioDataSet.TableDataTable dataTable) {
        ...
        public virtual FicharioDataSet.TableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            FicharioDataSet.TableDataTable dataTable = new FicharioDataSet.TableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(FicharioDataSet.TableDataTable dataTable) {
        ...
        public virtual int Insert(string username, string password, byte[] photo) {
            if ((username == null)) {
        ...
        public virtual int Update(string username, string password, byte[] photo, string Original_username, string Original_password) {
            if ((username == null)) {
                throw new global::System.ArgumentNullException("username");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string password, byte[] photo, string Original_username, string Original_password) {
            return this.Update(Original_username, password, photo, Original_username, Original_password);
        }
    }
